...
% Additional analysis without the baseline time
%% Analysis of order 4:
participants =51;
conditions =5;
trials = 15;
            ...
            for theta=beta+1:L-1
                for delta=theta+1:L
                    ...
                    for participant =1:participants
                        ...
                        writematrix(string(JSD) + ',' + string(alpha) + ',' + string(beta) + ',' + string(theta) + ',' + string(delta) + ':' + 'PPT'+ string(participant),'ParticipantLevelAnalysisLevel4_NoBaseline.txt','WriteMode','append')
                    ...
                    writematrix(string(JSD) + ',' + string(alpha) + ',' + string(beta) + ',' + string(theta) + ',' + string(delta),'ConditionLevelAnalysisLevel4_NoBaseline.txt','WriteMode','append')
                end
            end
        end
    end